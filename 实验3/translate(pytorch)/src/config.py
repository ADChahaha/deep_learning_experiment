...
cfg = EasyDict(
    {
        ...
        'checkpoint_path':'./ckpt/latest.pt', #储存检查点的位置
        'log_dir':'./runs/gru_translation', #TensorBoard 日志目录
        'history_path':'./ckpt/history.jsonl', #训练历史记录
        'best_checkpoint_path':'./ckpt/best_bleu.pt', #最佳 BLEU 检查点
        'latest_checkpoint_path':'./ckpt/latest.pt', #最新检查点
    }
)
